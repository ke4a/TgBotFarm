...
namespace BotFarm.UnitTests.Controllers
{
    ...
    public class HomeControllerTests
    {
        ...
        [Test]
        public void Index_WhenUserIsNotAuthenticatedAndDebuggerNotAttached_ReturnsContentResult()
        {
            // Arrange
            ...
            // Note: We can't easily mock Debugger.IsAttached in a unit test
            // This test assumes debugger is not attached in the test environment

            // Act
            var result = _controller.Index();

            // Assert
            // In a real test environment, Debugger.IsAttached is typically false
            // so this should return ContentResult when user is not authenticated
